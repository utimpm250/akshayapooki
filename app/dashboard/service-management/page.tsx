...
const initialServices: ServiceItem[] = [
  { id: '1', name: 'Aadhaar 125', wallet: 'CASH', deptFee: 0, srvCharge: 125, commission: 5, followupDays: 0 },
  { id: '2', name: 'Aadhaar 50', wallet: 'CASH', deptFee: 0, srvCharge: 50, commission: 5, followupDays: 0 },
  { id: '3', name: 'Aadhaar 75', wallet: 'CASH', deptFee: 0, srvCharge: 75, commission: 5, followupDays: 0 },
  { id: '4', name: 'Aadhaar online Demographic Update', wallet: 'Edistrict', deptFee: 83, srvCharge: 57, commission: 5, followupDays: 2, portalUrl: 'https://uidai.gov.in' }
];
...
export default function ServiceManagementPage() {
  ...
  // മോഡൽ പോപ്പ്അപ്പ് കൺട്രോൾ ചെയ്യുന്നതിനുള്ള സ്റ്റേറ്റുകൾ
  ...
  // വാലറ്റുകളുടെ ലിസ്റ്റ് (സ്ക്രീൻഷോട്ടിൽ ഉള്ളതുപോലെ)
  ...
  return (
    <div className="p-8 space-y-8 max-w-7xl w-full mx-auto relative">
      ...
      <div className="bg-gradient-to-r from-indigo-600 via-indigo-600 to-indigo-500 text-white rounded-2xl p-8 shadow-sm flex justify-between items-center relative overflow-hidden">
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl px-6 py-4 flex items-center gap-4">
                  ...
                  <tr key={service.id} className="hover:bg-slate-50/50 transition">
                    ...
                    <td className="py-4 px-6 text-right">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <button className="p-1.5 hover:bg-slate-100 rounded text-slate-400 hover:text-indigo-600 transition">
                          <Edit2 size={14} />
                        </button>
                        <button 
      ...
      {/* MODAL POPUP (EXACT MATCH TO YOUR SCREENSHOT) */}
      {isModalOpen && (
          ...
          <div className="bg-white rounded-3xl border border-slate-100 w-full max-w-lg shadow-2xl overflow-hidden p-6 space-y-5">
            ...
            <div className="flex justify-between items-center border-b border-slate-100 pb-4">
              <div className="flex items-center gap-2 text-indigo-600 font-bold text-base">
                <Briefcase size={20} />
                <h4 className="font-bold text-slate-800 text-base">Add New Service</h4>
              </div>
